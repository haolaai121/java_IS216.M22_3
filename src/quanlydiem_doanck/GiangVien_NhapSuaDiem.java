 ...
 * @author Admin
 */
public class GiangVien_NhapSuaDiem extends javax.swing.JFrame {
    ...
    public void getInfo(String MaSV, String TenSv, float qt, float th, float gk,float ck, float tb) {
        row = new String[50];
        row[0] = MaSV;
        row[1] = TenSv;
        row[2] = Float.toString(qt);
        row[3] = Float.toString(th);
        row[4] = Float.toString(gk);
        row[5] = Float.toString(ck);
        row[6] = Float.toString(tb); 
    }
    ...
    public void setTableModel() {
        ...
        String tieude[] = {"MSSV", "Họ Tên", "QT", "TH", "GK", "CK", "TB"};
    ...
    private void btTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btTimActionPerformed
        String lopHoc = (String) cbLop.getSelectedItem();
        setTableModel();
        ...
        try {
            ...
            String sql = "SELECT * FROM  DIEMSO JOIN SINHVIEN ON DIEMSO.MASV = SINHVIEN.MASV WHERE MAMH = ? AND MAGV = ?";
    ...
    private void btLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLuuActionPerformed
        ...
        try {
            String strSQL = "UPDATE DIEMSO SET DIEMQT = ?, DIEMTH = ?, DIEMGK = ?, DIEMCK = ?, DIEMTB=? WHERE MAMH = ? AND MAGV = ?";
            Connection con = null;
            con = SQLServerConnection.getSQLServerConnection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiangVien_NhapSuaDiem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GiangVien_NhapSuaDiem().setVisible(true);
            }
        });
    }
