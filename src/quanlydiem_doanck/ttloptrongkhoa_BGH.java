 ...
 * @author Admin
 */
public class ttloptrongkhoa_BGH extends javax.swing.JFrame {

    /**
     * Creates new form Nhapchinhsuadiem_GV
     */
    public ttloptrongkhoa_BGH() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Tbthongtin.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "MÃ LỚP", "KHOA", "CVHT", "NIÊN KHÓA"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ttloptrongkhoa_BGH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ttloptrongkhoa_BGH().setVisible(true);
            }
        });
    }
